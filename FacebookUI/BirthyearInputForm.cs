...
namespace FacebookUI
{
    public partial class BirthyearInputForm : Form
    {
        ...
        public BirthyearInputForm(FriendsDiagnosticsLogic i_FriendsDiagnosticsLogic)
        {
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                r_FriendsDiagnosticsLogic.FilterParameterSelectedValue = BirthyearTextBox.Text;
                Close();
            }
        }
    }
